...
const games = [
    ...
    },
    {
        ...
        name: 'LOL',
        description: "Whether you're looking to sharpen your skills or enhance team coordination in LOL, Carriers provides the tools you need to review gameplay, set goals, and dominate in LOL tournaments. Let’s elevate your game!"
    },
    {
        src: '/images/overwatch.jpeg',
        smallSrc: '/images/overwatch.jpeg',
        name: 'Overwatch',
        description: "Whether you're looking to sharpen your skills or enhance team coordination in Overwatch, Carriers provides the tools you need to review gameplay, set goals, and dominate in Overwatch tournaments. Let’s elevate your game!"
    }
]
